...
const {GetQuestions, AddQuestion, GetSingleQuestion,BookmarkQuestion, DeleteQuestion,DeleteComment, VoteUp, VoteDown,CommentAnswer,GetAnswers,VoteUpAnswer,VoteDownAnswer, AddAnswer, DeleteAnswer }= require('../controllers/questions.controllers');
